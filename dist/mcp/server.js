...
function readArguments(request) {
    ...
    return {
        ...
        workers: Array.isArray(args.workers)
            ? args.workers.filter((value) => typeof value === "string")
            : undefined,
...
export async function startServer() {
                ...
                inputSchema: {
                    ...
                    properties: {
                        ...
                        workers: {
                            ...
                            description: "Optional worker order. Built-ins include codex, gemini, local, ollama. You can also use discovered/manual workers from configuration."
                        },
                        output_format: {
                            type: "string",
                            enum: ["json", "markdown"],
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        try {
            ...
            const text = result.output_format === "markdown"
