...
function mapLegacyFieldsToWorkers(settings) {
    ...
    const fallbackLooksDefault = arraysEqual(fallbackPriority, DEFAULT_SETTINGS.routing?.fallback_priority);
    if (configuredDefaultWorkers.length > 0 &&
